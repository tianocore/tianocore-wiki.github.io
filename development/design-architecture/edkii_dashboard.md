...
<th colspan="3" style="color:#085FA8;font-weight:bold;font-size:200%;text-align:left">
...
<tr style="background-color:#A6C9E0;color:#05477D;font-weight:bold">
...
<tr style="background-color:#F0F6F8;color:#FF0000">

<td>

Intel UDK2010 page, with links to all
kits and latest release
...
<tr style="background-color:#E0EBF4;color:#FF0000">
...
<tr style="background-color:#E0EBF4;color:#0E63AA">
...
<tr style="background-color:#F0F6F8;color:#0E63AA">
...
<th colspan="2" style="color:#085FA8;font-weight:bold;font-size:200%;text-align:left">
...
[https://github.com/01org/edkiibuilddataviewer/](https://github.com/01org/edkiibuilddataviewer/)
A Windows application to view all EDK II build log files, and display
and quickly find where PCDs and GUIDs are defined,
what source files are used in a build, and more!
